...
└── tests/
    ...
    │   ├── test_lua_python_equivalence.py    ★ Cross-checks rawes_flight.lua math against controller.py (slerp, cyclic, orbit track, PWM)
