...
Usage
-----
  python envelope/compute_map.py --quick        # fast preview
  python envelope/compute_map.py --full         # fine grid, save map
  python envelope/compute_map.py --quick --wind 10
  python envelope/compute_map.py --load map.npz  # reload saved grid
"""
