...
Usage
-----
  python envelope/analyse_envelope.py --phase reel_out
  python envelope/analyse_envelope.py --phase reel_in
  python envelope/analyse_envelope.py --el 80 --tension 200 --wind 10
  python envelope/analyse_envelope.py --el 80 --tension 200 --wind 10 --col 0.08
  python envelope/analyse_envelope.py --envelope --wind 10
"""
