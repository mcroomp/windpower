...
Usage:
    RAWES_HIL_PORT=COM4 .venv/Scripts/python.exe scripts/query_hardware.py
"""
...
L("|---------|------------|-------------|")
L("| Lua mode param | RAWES_MODE (script-generated) | RAWES_MODE (script-generated) |")
L("| Yaw slope param | RAWES_YAW_SLP (script-generated) | RAWES_YAW_SLP (script-generated) |")  
