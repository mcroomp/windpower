...
Usage:
    python simulation/analysis/arduloop_pid_replay.py <log_dir> [--window START_S END_S]

Example:
    python simulation/analysis/arduloop_pid_replay.py simulation/logs/test_lua_flight_steady_sitl \\
        --window 60 75
"""
