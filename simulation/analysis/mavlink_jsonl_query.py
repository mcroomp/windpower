...
(simulation/scripts/_calibrate/run.py). Every line is one JSON object:
...
from mavlink_log import iter_messages  # noqa: E402
from ekf_flags import MAV_MODE_ARMED, ARDU_MODES, MAV_STATE  # noqa: E402
