...
class TelRow:
    ...
    mav_att_roll_rate_rads: float = float("nan")  # MAVLink ATTITUDE rollspeed [rad/s]
    mav_att_pitch_rate_rads: float = float("nan") # MAVLink ATTITUDE pitchspeed [rad/s]
    ...
    yaw_sp_rads:        float = 0.0   # AP yaw rate setpoint [rad/s]
    roll_rate_err_rads: float = 0.0   # roll_sp_rads - omega_x [rad/s]
    pitch_rate_err_rads: float = 0.0  # pitch_sp_rads - omega_y [rad/s]
    yaw_rate_err_rads:  float = 0.0   # yaw_sp_rads - omega_z [rad/s]
    rate_roll_p_contrib:  float = float("nan")
    rate_roll_i_contrib:  float = float("nan")
    rate_roll_d_contrib:  float = float("nan")
    rate_roll_ff_contrib: float = float("nan")
    rate_pitch_p_contrib:  float = float("nan")
    rate_pitch_i_contrib:  float = float("nan")
    rate_pitch_d_contrib:  float = float("nan")
    rate_pitch_ff_contrib: float = float("nan")
    rate_yaw_p_contrib:  float = float("nan")
    ...
    def from_physics(
        ...
        *,
        ...
        mav_att_pitch_deg: float = float("nan"),
        mav_att_yaw_deg: float = float("nan"),
        mav_att_roll_rate_rads: float = float("nan"),
        mav_att_pitch_rate_rads: float = float("nan"),
        mav_att_yaw_rate_rads: float = float("nan"),
        mav_att_target_roll_deg: float = float("nan"),
        mav_att_target_pitch_deg: float = float("nan"),
        mav_att_target_yaw_deg: float = float("nan"),
        mav_att_target_roll_rate_rads: float = float("nan"),
        ...
        return cls(
            ...
            rate_roll_ff_contrib = float(rate_roll_ff_contrib),
            rate_pitch_p_contrib = float(rate_pitch_p_contrib),
            rate_pitch_i_contrib = float(rate_pitch_i_contrib),
            rate_pitch_d_contrib = float(rate_pitch_d_contrib),
            rate_pitch_ff_contrib = float(rate_pitch_ff_contrib),
            rate_yaw_p_contrib  = float(rate_yaw_p_contrib),
            ...
            mav_att_roll_rate_rads=float(mav_att_roll_rate_rads),
            mav_att_pitch_rate_rads=float(mav_att_pitch_rate_rads),
            mav_att_yaw_rate_rads=float(mav_att_yaw_rate_rads),
