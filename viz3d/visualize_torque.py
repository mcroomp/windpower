...
Usage
-----
  python viz3d/visualize_torque.py simulation/logs/torque_telemetry.csv
  python viz3d/visualize_torque.py telemetry.csv --export out.gif --fps 15
"""
...
from viz3d.torque_telemetry import TorqueTelemetryFrame
...
def main() -> None:
    ...
    if args.telemetry:
        ...
        log_dir   = Path(simulation.__file__).resolve().parent / "logs"
