...
Examples:
    .venv/Scripts/python.exe analysis/arm_target_timeline.py test_lua_flight_ic_passive_sitl
    .venv/Scripts/python.exe analysis/arm_target_timeline.py simulation/logs/test_lua_flight_ic_passive_sitl --csv out.csv
"""
