...
Usage (from repo root):
  wsl.exe bash -c 'python3 /mnt/e/repos/windpower/analysis/analyse_pumping_cycle.py'
  wsl.exe bash -c 'python3 /mnt/e/repos/windpower/analysis/analyse_pumping_cycle.py --csv /path/to/telemetry.csv'
  python3 analysis/analyse_pumping_cycle.py --csv simulation/logs/telemetry_pumping.csv
"""
