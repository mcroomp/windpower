...
Usage
-----
    .venv/Scripts/python.exe analysis/pump_diagnosis.py
    .venv/Scripts/python.exe analysis/pump_diagnosis.py --test test_pump_cycle_unified --bucket 1
    .venv/Scripts/python.exe analysis/pump_diagnosis.py --verbose   # full tables to stdout
