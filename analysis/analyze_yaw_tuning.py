...
Usage:
    python analysis/analyze_yaw_tuning.py <path/to/run_yaw_*.csv>
    python analysis/analyze_yaw_tuning.py <csv> --window 5
    python analysis/analyze_yaw_tuning.py <csv> --no-plot
"""
