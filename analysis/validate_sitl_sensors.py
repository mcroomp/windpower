...
Usage
-----
  python analysis/validate_sitl_sensors.py <log_name>
  e.g.  python analysis/validate_sitl_sensors.py kin_gps_test_kinematic_gps
"""
...
LOG_ROOT   = Path(simulation.__file__).resolve().parent / "logs"
