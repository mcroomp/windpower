...
Usage:
    python analysis/compare_pumping.py [--phase cycle1_reel-out] [--bucket 1]
    python analysis/compare_pumping.py --py logs/... --lua logs/...
"""
...
_SIM = Path(_simulation_pkg.__file__).resolve().parent  # simulation/
